...
function tea42(input) {
  ...
  return arr
    .map((letter) => (letter === 2 ? "t" : letter === "2" ? "t" : letter))
    .join("");
}

//p - string or int
//r - string but with '2' or 2 replaced with 't'
//ps - turn input into String and then split into array
//loop over array, replace 2 with 't' and replace '2' with 't'
