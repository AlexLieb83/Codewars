...
//p - object
//r - array with key.length that equal 5 AND length of value equal 5
//ps - loop over object, check if key.length === 5, push to array,
//check if value.length === 5, push to array
